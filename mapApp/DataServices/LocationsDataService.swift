...
class LocationsDataService {
    ...
    static let locations: [Location] = [
        ...
        Location(
            ...
            link: URL(string: "https://en.wikipedia.org/wiki/Pantheon,_Rome")!),
        Location(
            name: "Trevi Fountain",
            cityName: "Rome",
            ...
            link: URL(string: "https://en.wikipedia.org/wiki/Trevi_Fountain")!),
        Location(
            name: "Eiffel Tower",
            cityName: "Paris",
        ...
        Location(
            ...
            link: URL(string: "https://en.wikipedia.org/wiki/Louvre")!),
    ]
